...
function render(res) {
    ...
    <div class="content">
        ...
        <div class="currency">
            <span>India  ₹-${res.market_data.current_price.inr} </span>
            <span>US $-${res.market_data.current_price.usd} </span>
            <span>Europe €-${res.market_data.current_price.eur} </span>
            <span>Polend £-${res.market_data.current_price.gbp} </span>
        </div>  
    </div>
    <div class="desc">
    <h2>Description :- </h2>
